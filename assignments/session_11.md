...
Save the completed sketch as "SS7-[FirstName + Last Initial]" (for example, "SS7-AlexandraP"). Submit to your Github Class Repo **before the beginning of class on Friday 5/1**.      

### Final Project Proposal  
See [final project requirements](https://github.com/entertainmenttechnology/Palocz-MTEC1201_D02-Spring2026/blob/main/assignments/FINAL_PROJECT.md) for details. Submit pdf via **email to alexandra.palocz69@citytech.cuny.edu by Friday 5/1.**  
